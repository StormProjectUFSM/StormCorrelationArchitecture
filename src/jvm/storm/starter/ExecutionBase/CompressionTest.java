...
public class CompressionTest{
	public static void main(String[] args) throws Exception{
		...
		builder.setBolt("call-log-correlationtype-bolt", new ProtocolSizeBolt("/home/storm/StormInfrastructure/Storm/apache-storm-1.0.3/examples/storm-starter/src/jvm/storm/starter/ExecutionBase/CompressionTest.xml")).shuffleGrouping("call-log-reader-spout");
